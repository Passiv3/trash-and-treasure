...
const Card = (props) => {
    ...
    <article className="card-container">
        ...
        <div className = "button-container">
            <p className="counter">{props.trashCount}</p>
            <Button className = "trash-button" buttonText = {<span className="material-symbols-outlined">close</span>}></Button>
            <p className="counter">{props.treasureCount}</p>
            <Button className = "treasure-button" buttonText = {<span className="material-symbols-outlined">check</span>}></Button>
        </div>
    </article>
    );
};
